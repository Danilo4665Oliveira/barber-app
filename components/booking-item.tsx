...
const BookingItem = ({ booking }: BookingItemProps) => {
  ...
  const handleCancelBooking = async () => {
    try {
      ...
      console.error(error)
      toast.error("Não foi possível cancelar sua reserva. Tente novamente")
    }
  }
              ...
              <Dialog>
                ...
                <DialogContent className="w-[90%]">
                  <DialogHeader>
                    ...
                    <DialogDescription className="flex-column flex">
                      Ao cancelar, você perderá sua reversa e não poderá
